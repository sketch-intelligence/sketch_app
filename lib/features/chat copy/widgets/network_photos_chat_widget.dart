...
//   const NetworkPhotoChatWidget({Key? key, required this.messageModel,  required this.whenDone})
//       : super(key: key);
//
//   @override
...
//       mediaList.add(NetworkMediaListModel(isPhoto: true, url: element.url??''));
//     });
//     widget.messageModel.videos?.forEach((element) {
//       mediaList.add(NetworkMediaListModel(isPhoto: false, url: element.url??''));
//     });
//
//   }
//
...
//                                       color:Colors.white, fontSize: AppFontSize.size_26),
//                                 )
//                               ],
//                             ),
//                       )
