...
//    const AssetsMessageCard({Key? key, required this.messageModel, required this.idLocal, required this.whenDone}) : super(key: key);
//
//   @override
...
//                   child: Padding(
//                     padding: const EdgeInsets.symmetric(vertical: 16.0,horizontal: 16),
//                     child: AssetsPhotoChatWidget(mediaList: widget.messageModel.mediaList ?? [],),
//                   ),
//                 ),
//                 Positioned.fill(
//                   child: Container(
...
//           index = context.read<ChatCubit>().msgList.indexWhere((element) => (element.idLocal==widget.idLocal));
...
//         },
//         useCaseCallBack: () {
//           return  SendMessageUseCase(ChatRepository()).call(params: ChatParams(
//               senderId: CacheHelper.userID??0,
//               recieverId: (CacheHelper.userID ?? '') !=
